    ...
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 h-16 glass-taskbar flex items-center justify-center px-4 z-50 border-t border-glass-border">
        ...
        >
          ...
          <img src={"https://raw.githubusercontent.com/chikocharles/Windows-11-Portfolio/refs/heads/main/src/assets/windows_logo-removebg-preview.png"} alt="Tech Stack" className="h-10 w-30 object-contain " />
